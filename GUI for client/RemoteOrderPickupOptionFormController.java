 ...
 *
 */
public class RemoteOrderPickupOptionFormController implements Initializable {
	...
	/**
	 *  loads the combobox with required data
	 */
	...
	/**
	 *  loads the comboboxes with required data
	 */
	 ...
	 * @param event
	 * @throws IOException
	 *  sends user to the page create order
	 */
	@FXML
	public void ClickMakeOrder(ActionEvent event) throws IOException{
		...
		if(MainPageFormController.results[1].equals("1")) {
			...
			if(loc==null || deviceCode==null) {
				lblChoose.setText("Please choose Area and device Id");
			}else {
	 ...
	 * @param event
	 * @throws IOException
	 *  sends the user to the page that was open before this page
	 */
	@FXML
	...
	/**
	 *  initializes the comboboxes with required data
	 */
	@Override
